...
public class Frm_Login extends javax.swing.JFrame {
    ...
    private void login(){
       ...
       try {
            ...
            Conexion.Cls_Conexion objetoConexion = new Conexion.Cls_Conexion();
            ...
            ps.setString(2,txt_clave.getText());
            
            rs = ps.executeQuery();
      
             if(rs.next()){
            JOptionPane.showMessageDialog(null,"BIENVENIDO :3");
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Ecuasurf logo.jpg"))); // NOI18N
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 10, 350, 430));

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Ecuasurf fondo negro.jpeg"))); // NOI18N
        jLabel5.setText("jLabel5");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 420, 430));
