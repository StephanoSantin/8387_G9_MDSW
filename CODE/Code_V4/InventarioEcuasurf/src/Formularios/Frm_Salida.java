...
private void guardar() {
    String nfac = txt_nfactura.getText().trim();
    String codigo = txt_codigo.getText().trim();
    String cantidadStr = txt_cantidad.getText().trim();
    if (nfac.isEmpty() || codigo.isEmpty() || cantidadStr.isEmpty()) {
    ...
    if (fechaa == null || fechaa.after(fechaActual)) {
        JOptionPane.showMessageDialog(this, "La fecha de salida no puede ser futura", "Error", JOptionPane.ERROR_MESSAGE);
        return;
    }
